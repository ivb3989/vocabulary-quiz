...
$(document).ready(function () {
  ...
  /* function generateQuestion() {
    return questions[generateNumber(questions.length)];
  } */
  ...
  function resetGame() {
    ...
    index = 0;
    uniques = chance.unique(chance.natural, 10, { min: 1, max: questions.length - 1, }).map((x) => (x !== 7 ? x : Math.floor(Math.random() * 7)));
